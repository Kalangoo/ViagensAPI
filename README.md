...
Justificativa Técnica (Resumida) <br>
...
Pré-requisitos: Java JDK 17+ instalado. <br>
Baixar o repositório:Bashgit clone (https://github.com/Kalangoo/ViagensAPI) <br>
cd agencia-viagens-api <br>
Executar via terminal (Windows):PowerShell.\mvnw.cmd spring-boot:run <br>
(Ou abra a classe AgenciaViagensApplication.java no VS Code e clique em Run). <br>
